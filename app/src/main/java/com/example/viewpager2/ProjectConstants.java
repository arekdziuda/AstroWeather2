...
public final class ProjectConstants {
    ...
    public static int FIVETEEN_SECONDS = 15000;
    public static int FIVE_MINUTES = 300000;
    public static int TEN_MINUTES = 600000;
    public static int FIVETEEN_MINUTES = 900000;
    public static double DMCS_LONGITUDE = 19.4528;
    public static double DMCS_LATITUDE = 51.7460238;
